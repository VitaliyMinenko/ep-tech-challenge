    ...
    <div>
        ...
        <div class="flex">
            ...
            <div class="w-2/3">
                ...
                <ClientBookings v-if="currentTab === 'bookings'" :bookings="client.bookings" />
                <ClientJournals v-if="currentTab === 'journals'" :client="client" :journals="client.journals" />
            </div>
        </div>
    </div>
</template>
...
import ClientJournals from './ClientJournals.vue';
